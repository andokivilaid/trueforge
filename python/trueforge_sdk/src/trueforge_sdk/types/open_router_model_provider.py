...
class OpenRouterModelProvider(UncheckedBaseModel):
    auth: ModelProviderAuth
    base_url: typing.Optional[str] = pydantic.Field(default="https://openrouter.ai/api/v1")
    """
    ...
    type: typing.Literal["openrouter"] = "openrouter"
